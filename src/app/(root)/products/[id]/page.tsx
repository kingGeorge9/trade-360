      ...
      <section className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_480px]">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-center gap-2 rounded-full border border-light-300 px-6 py-4">
              <FavoriteButton productId={product.id} size="md" />
              <span className="text-body-medium text-dark-900">Favorite</span>
            </div>
          </div>
