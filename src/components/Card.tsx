...
export default function Card({
  ...
  const articleClassName = `group rounded-xl bg-light-100 ring-1 ring-light-300 transition-colors hover:ring-dark-500${
    className ? ` ${className}` : ""
  }`;
  ...
  const content = (
    <article className={articleClassName}>
      <div className="relative aspect-square overflow-hidden rounded-t-xl bg-light-200">
        ...
        {badge && (
          <div
            className={`absolute left-3 top-3 rounded-full bg-light-100 px-3 py-1 text-caption font-medium ${
